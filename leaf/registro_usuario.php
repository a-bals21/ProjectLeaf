    ...
    <section>
        <article>
            ...
            if (isset($_GET['err'])) {
                $err = $_GET['err'];
                if ($err == 1) {
                    echo '<div class="nota">Username ya registrado, pruebe con otro</div>';
                }
            }
            ?>
            <form action="./data/registrar_cliente.php" method="post">
                <fieldset>
                    <label for="nombres">Nombres:</label>
                    <input type="text" name="nombres" id="nombres" placeholder="nombres" autofocus required>
                </fieldset>
                <fieldset>
                ...
                <fieldset>
                    ...
                    <div>
                        <input type="checkbox" name="drama-misterio" id="drama-misterio">
                        <label for="drama-misterio">Drama/Misterio</label>
                    </div>
                    <div>
                        <input type="checkbox" name="comic-manga" id="comic-manga">
                        <label for="comic-manga">Cómic/Manga</label>
                    </div>
                    <div>
                        <input type="checkbox" name="accion-aventura" id="accion-aventura">
                        <label for="accion-aventura">Acción/Aventura</label>
                    </div>
                    <div>
                        <input type="checkbox" name="cf-fantasia" id="cf-fantasia">
                ...
                <fieldset>
                    ...
                    <div>
                        <label for="password-r">Rep. la Contraseña:</label>
                        <input type="password" name="password-r" id="password-r" placeholder="repite tu contraseña"
                            required>
                    </div>
                </fieldset>
